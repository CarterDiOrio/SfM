...
int main()
{
  ...
  sfm::utils::RecordingReader reader{"./stuff/ish/", 30};
  ...
  sfm::ReconstructionOptions options{
    model,
    6000.0,
    "/home/cdiorio/ws/winter/stuff/ish/voc",
  };
  ...
  // reconstruction.get_map()->global_bundle_adjustment(model);
  std::cout << "frames: " << reconstruction.get_map()->keyframes.size() << std::endl;
